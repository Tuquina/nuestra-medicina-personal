...
func run(logger *slog.Logger) error {
	...
	authService := authentication.NewService(googleProvider, authRepository, cfg.AdminEmails, cfg.SessionTTL)
	authorizer := postgres.NewSessionAuthorizer(pool, cfg.AdminEmails)
	...
	backofficeService := backoffice.NewService(backofficeRepository, cfg.AdminEmails)
